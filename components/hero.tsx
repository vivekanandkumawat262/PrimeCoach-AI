  ...
  return (
    <div className="flex flex-col gap-16 items-center">
      ...
      <div className="flex flex-col gap-3 items-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-950 px-4 py-1 text-xs uppercase tracking-[0.2em] text-slate-100">
      ...
      {/* Subheading */}
      <p className="text-sm lg:text-base text-slate-800 max-w-xl text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center">
        <a
          href="auth/sign-up"
          className="inline-flex items-center justify-center rounded-md bg-indigo-800 px-5 py-2 text-sm font-medium text-white hover:bg-indigo-400 transition"
        >
          Get started free
        </a>
        <a
          href="/onboarding"
          className="inline-flex items-center justify-center rounded-md border border-slate-700 px-5 py-2 text-sm font-medium text-slate-800 hover:bg-slate-900/60 transition"
        >
          View demo flow
        </a>
      </div>
